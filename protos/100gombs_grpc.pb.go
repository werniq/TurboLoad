...
func (c *fileServiceClient) DownloadFile(ctx context.Context, in *DownloadRequest, opts ...grpc.CallOption) (FileService_DownloadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[0], "/protofiles.FileService/DownloadFile", opts...)
	if err != nil {
		return nil, err
	}
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protofiles.FileService",
